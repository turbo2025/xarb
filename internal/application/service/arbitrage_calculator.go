...
func (ac *ArbitrageCalculator) CalculateSpread(long *model.FuturesPrice, short *model.FuturesPrice, makerFee float64) *model.SpreadArbitrage {
...
func (ac *ArbitrageCalculator) CalculateFunding(long *model.FuturesPrice, short *model.FuturesPrice, holdingHours int) *model.FundingArbitrage {
	if long == nil || short == nil {
		return nil
	}
