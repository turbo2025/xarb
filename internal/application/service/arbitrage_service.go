...
func (as *ArbitrageServiceImpl) ScanSpreadOpportunities(ctx context.Context, price1, price2 *model.FuturesPrice) error {
...
func (as *ArbitrageServiceImpl) ScanFundingOpportunities(ctx context.Context, price1, price2 *model.FuturesPrice, holdingHours int) error {
	if price1 == nil || price2 == nil || price1.Symbol != price2.Symbol {
		return fmt.Errorf("invalid prices for comparison")
	}
