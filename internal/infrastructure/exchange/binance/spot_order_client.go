...
func (c *SpotOrderClient) PlaceOrder(ctx context.Context, symbol string, side string, quantity float64, price float64, isMarket bool) (string, error) {
	// TODO: 实现 POST /api/v3/order
	// Binance 现货 API 文档: https://binance-docs.github.io/apidocs/spot/cn/#2ed90cb94e
	return "", fmt.Errorf("not implemented")
}

// CancelOrder 取消订单
func (c *SpotOrderClient) CancelOrder(ctx context.Context, symbol string, orderId string) error {
	// TODO: 实现 DELETE /api/v3/order
	return fmt.Errorf("not implemented")
}

// GetOrderStatus 查询订单状态
func (c *SpotOrderClient) GetOrderStatus(ctx context.Context, symbol string, orderId string) (*BinanceOrderStatus, error) {
	// TODO: 实现 GET /api/v3/order
...
// GetOpenOrders 获取挂单
func (c *SpotOrderClient) GetOpenOrders(ctx context.Context, symbol string) ([]*BinanceOrderStatus, error) {
	// TODO: 实现 GET /api/v3/openOrders?symbol=BTCUSDT
	return nil, fmt.Errorf("not implemented")
}

// GetOrderHistory 获取订单历史
func (c *SpotOrderClient) GetOrderHistory(ctx context.Context, symbol string, limit int) ([]*BinanceOrderStatus, error) {
