...
func TestArbitrageRepoFuturesPrice(t *testing.T) {
	...
	if err := arbRepo.SaveFuturesPrice(ctx, price); err != nil {
	...
	t.Logf("✓ Futures price saved and retrieved: exchange=%s, symbol=%s, price=%.2f",
